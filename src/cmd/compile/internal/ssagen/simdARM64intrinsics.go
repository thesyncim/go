...
func simdARM64Intrinsics(addF func(pkg, fn string, b intrinsicBuilder, archFamilies ...sys.ArchFamily)) {
	...
	addF(simdPackage, "Int8x16.AbsDiff", opLen2(ssa.OpAbsDiffInt8x16, types.TypeVec128), sys.ARM64)
	addF(simdPackage, "Int16x8.AbsDiff", opLen2(ssa.OpAbsDiffInt16x8, types.TypeVec128), sys.ARM64)
	addF(simdPackage, "Int32x4.AbsDiff", opLen2(ssa.OpAbsDiffInt32x4, types.TypeVec128), sys.ARM64)
	addF(simdPackage, "Uint8x16.AbsDiff", opLen2(ssa.OpAbsDiffUint8x16, types.TypeVec128), sys.ARM64)
	addF(simdPackage, "Uint16x8.AbsDiff", opLen2(ssa.OpAbsDiffUint16x8, types.TypeVec128), sys.ARM64)
	addF(simdPackage, "Uint32x4.AbsDiff", opLen2(ssa.OpAbsDiffUint32x4, types.TypeVec128), sys.ARM64)
	...
	addF(simdPackage, "Int16x8.MulHighRound", opLen2(ssa.OpMulHighRoundInt16x8, types.TypeVec128), sys.ARM64)
	addF(simdPackage, "Int32x4.MulHighRound", opLen2(ssa.OpMulHighRoundInt32x4, types.TypeVec128), sys.ARM64)
	...
	addF(simdPackage, "Int32x4.DotProd", opLen3(ssa.OpDotProdInt32x4, types.TypeVec128), sys.ARM64)
	addF(simdPackage, "Uint32x4.DotProd", opLen3(ssa.OpDotProdUint32x4, types.TypeVec128), sys.ARM64)
	addF(simdPackage, "Int32x4.DotProdUS", opLen3(ssa.OpDotProdUSInt32x4, types.TypeVec128), sys.ARM64)
	addF(simdPackage, "Int32x4.MatMulUS", opLen3(ssa.OpMatMulUSInt32x4, types.TypeVec128), sys.ARM64)
